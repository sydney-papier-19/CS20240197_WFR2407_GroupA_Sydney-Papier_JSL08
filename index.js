...
class BankBranch { 
    ...
    constructor(branchInfo) {
        ...
        if  (bankBranchInstance === null ) {
            // created new instance with provided 'branchInfo'
            // 'this' refers to the current instance being created.
            this.branchInfo = branchInfo;
            // assigned new instance, 'this' to 'bankBranchInstance'
            bankBranchInstance = this;
        }
        // returns the instance whether it's newly created or existing.
...
// This pseudo-code provides a step-by-step explanation of how to implement the Singleton Pattern for managing a 
//single instance of the `BankBranch` class throughout the application, ensuring that multiple instances refer 
//to the same object.
// NOTES:
